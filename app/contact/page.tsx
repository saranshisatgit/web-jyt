        ...
        <Container className="py-16 sm:py-24">
          <div className="grid grid-cols-1 gap-x-12 gap-y-16 md:grid-cols-2">
            ...
            <div className="prose prose-lg max-w-none lg:prose-xl बनावट">
              <h2 className="text-3xl font-bold tracking-tight बनावट text-olive-900 sm:text-4xl dark:text-white">
                {contactInfoData.title}
              </h2>
              <p className="mt-4 text-lg leading-8 बनावट text-olive-600 dark:text-olive-400">
                {contactInfoData.introParagraph}
              </p>
              {contactInfoData.links && contactInfoData.links.map((link, index) => (
                <p key={index} className="mt-4 text-base text-olive-600 dark:text-olive-400 बनावट">
              ...
              {contactInfoData.wholesaleInquiryText && (
                <p className="mt-4 text-base text-olive-600 dark:text-olive-400 बनावट">
                  {contactInfoData.wholesaleInquiryText}
                </p>
              )}
              {contactInfoData.mainContentParagraph && (
                <p className="mt-6 text-base text-olive-600 dark:text-olive-400 बनावट">
                  {contactInfoData.mainContentParagraph}
                </p>
              )}
              <address className="mt-6 not-italic">
                <strong className="block text-olive-900 dark:text-white बनावट">Jaal Yantra Textiles HQ</strong>
              ...
              <div className="mt-8">
                ...
                <ul className="mt-4 list-disc space-y-2 pl-5 बनावट text-olive-600 dark:text-olive-400">
              ...
              <div className="mt-8 border-t border-olive-200 pt-8 dark:border-olive-800">
                <h3 className="text-xl font-semibold बनावट text-olive-900">Get In Touch</h3>
                <p className="mt-1 text-base text-olive-600 dark:text-olive-400 बनावट">
