...
const AgreementView = ({ responseId, accessToken }: AgreementViewProps) => {
  ...
  const getStatusBadge = (status: string) => {
    const statusColors = {
      ...
      expired: 'bg-navy-100 text-navy-800'
    };

    return (
      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${statusColors[status as keyof typeof statusColors] || 'bg-navy-100 text-navy-800'}`}>
            ...
            <section className="mt-8">
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-lg shadow-lg animate-fade-in text-center">
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span className="text-navy-700">Loading agreement...</span>
                </div>
              </div>
            </section>
          </Container>
      ...
      <div>
        ...
        <main>
          <Container>
            <section className="mt-8">
              <div className="bg-white/80 backdrop-blur-sm p-8 rounded-lg shadow-lg animate-fade-in max-w-md mx-auto text-center">
                <div className="text-navy-400 text-5xl mb-4">📄</div>
                <h1 className="text-2xl font-bold text-navy-900 mb-2">Agreement Not Found</h1>
                <p className="text-navy-600">The requested agreement could not be found.</p>
              </div>
            </section>
          </Container>
        </main>
        ...
        <Container>
          <section className="mt-8 mb-24 min-h-[60vh]">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-lg mb-6 animate-fade-in">
                <div className="px-6 py-4 border-b border-navy-200">
                  <div className="flex items-center justify-between">
                    <h2 className="text-lg font-semibold text-navy-900">Agreement Details</h2>
                    {getStatusBadge(response.status)}
                  </div>
                </div>

                {/* Agreement Info */}
                <div className="px-6 py-4 bg-navy-50">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                      <span className="font-medium text-navy-700">Sent to:</span>
                      <p className="text-navy-900">{response.email_sent_to}</p>
                    </div>
                    <div>
                      <span className="font-medium text-navy-700">Sent on:</span>
                      <p className="text-navy-900">{formatDate(response.sent_at)}</p>
                    </div>
                    <div>
                      <span className="font-medium text-navy-700">Valid until:</span>
                      <p className="text-navy-900">{formatDate(agreement.valid_until)}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg mb-6 animate-fade-in">
                <div className="px-6 py-4 border-b border-navy-200">
                  <h2 className="text-lg font-semibold text-navy-900">Agreement Content</h2>
                </div>
                <div className="px-6 py-6">
                  <div
                    className="prose max-w-none text-navy-700 leading-relaxed"
              ...
              {hasResponded ? (
                <div className="bg-white rounded-lg shadow-lg animate-fade-in">
                  <div className="px-6 py-4 border-b border-navy-200">
                    <h2 className="text-lg font-semibold text-navy-900">Response Status</h2>
                  </div>
                  <div className="px-6 py-6">
                    <div className="text-center py-8">
                      ...
                      <div className="bg-navy-50 rounded-lg p-4 inline-block">
                ...
                <div className="bg-white rounded-lg shadow-lg animate-fade-in">
                  <div className="px-6 py-4 border-b border-navy-200">
                    <h2 className="text-lg font-semibold text-navy-900">Your Response</h2>
                  ...
                  <div className="px-6 py-6">
                    ...
                    <div className="mb-6">
                      <label htmlFor="response-notes" className="block text-sm font-medium text-navy-700 mb-2">
                        Additional Notes (Optional)
                      </label>
                      <textarea
                        id="response-notes"
                        rows={4}
                        className="w-full px-3 py-2 border border-navy-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div className="flex space-x-4">
                      <button
                        ...
                        disabled={isSubmitting}
                        className="flex-1 bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:bg-navy-400 disabled:cursor-not-allowed transition-colors"
                      >
                      ...
                      <button
                        ...
                        disabled={isSubmitting}
                        className="flex-1 bg-red-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:bg-navy-400 disabled:cursor-not-allowed transition-colors"
                      >
                ...
                <div className="bg-white rounded-lg shadow-lg animate-fade-in">
                  <div className="px-6 py-6 text-center">
                    <div className="text-navy-400 text-4xl mb-4">⏰</div>
                    <h2 className="text-lg font-semibold text-navy-900 mb-2">Response Period Ended</h2>
