...
const AgreementView = ({ responseId, accessToken }: AgreementViewProps) => {
  ...
  const getStatusBadge = (status: string) => {
    const statusColors = {
      ...
      expired: 'bg-olive-100 text-olive-800'
    };

    return (
      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${statusColors[status as keyof typeof statusColors] || 'bg-olive-100 text-olive-800'}`}>
                  ...
                  <div className="px-6 py-6">
                    ...
                    <div className="flex space-x-4">
                      <button
                        ...
                        disabled={isSubmitting}
                        className="flex-1 bg-green-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:bg-olive-400 disabled:cursor-not-allowed transition-colors"
                      >
                      ...
                      <button
                        ...
                        disabled={isSubmitting}
                        className="flex-1 bg-red-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:bg-olive-400 disabled:cursor-not-allowed transition-colors"
                      >
