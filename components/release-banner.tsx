...
export function ReleaseBanner({
  ...
  return (
    <div className="relative z-10 border-b border-navy-200/60 bg-navy-50">
      <div className="mx-auto flex max-w-7xl items-center justify-center gap-3 px-6 py-2 text-xs lg:px-10">
        ...
        />
        <span className="truncate font-medium text-navy-700">{announcement}</span>
        <Link
          href={href}
          className="inline-flex items-center gap-1 font-semibold text-navy-950 transition-colors hover:text-orange-700"
        >
          {cta}
