...
export function ProblemStatement() {
    ...
    return (
        <section className="relative z-0 overflow-hidden pt-12 sm:pt-16 pb-24 sm:pb-32 bg-navy-50 font-sans transition-colors duration-300">
            ...
            <div className="mx-auto max-w-[80rem] px-4 sm:px-6 lg:px-8">
                <div
                    ref={containerRef}
                    className="relative w-full h-[500px] lg:h-[600px] rounded-3xl overflow-hidden border border-navy-200/80 cursor-ew-resize select-none"
                ...
                >
                    ...
                    ═══════════════════════════════════════════════════════ */}
                    <div
                        className="absolute inset-0 bg-navy-100 transition-colors duration-300"
                    ...
                    >
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 pointer-events-none">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="font-serif italic text-xl text-navy-500/60 transition-colors duration-300 select-none">
                                    Manual
                                </span>
                            </div>
                        </div>
                        ...
                        >
                            <div className="w-9 h-9 rounded-xl border border-navy-400/50 bg-navy-50 flex items-center justify-center text-navy-600/80 transition-all duration-300 group-hover:border-red-400/60 group-hover:shadow-[0_0_15px_rgba(239,68,68,0.2)]">
                                <PencilSquareIcon className="w-5 h-5" />
                            </div>
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">Scratch Pad</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">Excel</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">WhatsApp</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">Spreadsheets</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">E-commerce</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">Chat</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">Notes</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-500/80 whitespace-nowrap group-hover:text-red-500/80 transition-colors">Data Sheets</span>
                        </motion.div>
                        ...
                        <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-20" style={{ zIndex: 5 }}>
                            <line x1="3%" y1="12%" x2="14%" y2="18%" stroke="currentColor" className="text-navy-400" strokeWidth="1" strokeDasharray="4 6" />
                            <line x1="2%" y1="50%" x2="13%" y2="72%" stroke="currentColor" className="text-navy-400" strokeWidth="1" strokeDasharray="3 8" />
                            <line x1="4%" y1="88%" x2="34%" y2="82%" stroke="currentColor" className="text-navy-400" strokeWidth="1" strokeDasharray="5 5" />
                            <line x1="34%" y1="25%" x2="38%" y2="58%" stroke="currentColor" className="text-navy-400" strokeWidth="0.8" strokeDasharray="2 10" />
                        </svg>
                        ...
                        >
                            <div className="text-[10px] font-mono text-navy-500/60 line-through">sync failed</div>
                        </motion.div>
                    ...
                    ═══════════════════════════════════════════════════════ */}
                    <div
                        className="absolute inset-0 bg-navy-50 z-20 transition-colors duration-300"
                    ...
                    >
                        ...
                        >
                            <div className="w-2 h-2 rounded-full bg-navy-400 shadow-[0_0_8px_rgba(163,230,53,0.8)]" />
                        </motion.div>
                        <motion.div
                            className="absolute pointer-events-none"
                        ...
                        >
                            <div className="w-10 h-10 rounded-full border border-navy-500/40 bg-navy-100 flex items-center justify-center text-navy-600 shadow-[0_0_14px_rgba(88,89,68,0.08)] transition-all duration-300 group-hover:shadow-[0_0_25px_rgba(163,230,53,0.5)] group-hover:border-lime-400/80">
                                <SwatchIcon className="w-5 h-5" />
                            </div>
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-600 font-bold whitespace-nowrap transition-colors duration-300 group-hover:text-lime-500">Design Tracing</span>
                            <motion.div 
                                className="absolute -bottom-1 opacity-0 group-hover:opacity-100 transition-opacity text-[9px] text-navy-500/70 whitespace-nowrap"
                                initial={{ y: 5 }}
                                whileHover={{ y: 0 }}
                            >
                                Connected
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-600 font-bold whitespace-nowrap transition-colors duration-300 group-hover:text-lime-500">Inventory</span>
                            <motion.div 
                                className="absolute -bottom-1 opacity-0 group-hover:opacity-100 transition-opacity text-[9px] text-navy-500/70 whitespace-nowrap"
                            >
                                Real-time sync
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-600 font-bold whitespace-nowrap transition-colors duration-300 group-hover:text-lime-500">Supplier Portal</span>
                            <motion.div 
                                className="absolute -bottom-1 opacity-0 group-hover:opacity-100 transition-opacity text-[9px] text-navy-500/70 whitespace-nowrap"
                            >
                                Unified access
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-600 font-bold whitespace-nowrap transition-colors duration-300 group-hover:text-lime-500">Orders</span>
                            <motion.div 
                                className="absolute -bottom-1 opacity-0 group-hover:opacity-100 transition-opacity text-[9px] text-navy-500/70 whitespace-nowrap"
                            >
                                Auto-fulfill
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-600 font-bold whitespace-nowrap transition-colors duration-300 group-hover:text-lime-500">Payments</span>
                            <motion.div 
                                className="absolute -bottom-1 opacity-0 group-hover:opacity-100 transition-opacity text-[9px] text-navy-500/70 whitespace-nowrap"
                            >
                                Integrated
                        ...
                        >
                            ...
                            <span className="font-mono text-[8px] tracking-widest uppercase text-navy-600 font-bold whitespace-nowrap transition-colors duration-300 group-hover:text-lime-500">Sheets</span>
                            <motion.div 
                                className="absolute -bottom-1 opacity-0 group-hover:opacity-100 transition-opacity text-[9px] text-navy-500/70 whitespace-nowrap"
                            >
                                Live data
                        ...
                        >
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-navy-500 -rotate-90 flex-shrink-0 transition-colors duration-300">
                                <path d="M5.5 3.21V20.8c0 .45.54.67.85.35l4.86-4.86H19.5c.32 0 .5-.4.27-.63L5.5 3.21z" fill="currentColor" />
                            </svg>
                            <span className="bg-navy-200/90 text-navy-800 border border-navy-300/60 text-[8px] font-bold px-2 py-0.5 rounded-full tracking-wide whitespace-nowrap backdrop-blur-sm transition-colors duration-300">
                                Inventory Sync
                            </span>
                        </motion.div>
                        ...
                        >
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-navy-600 -rotate-45 flex-shrink-0 transition-colors duration-300">
                                <path d="M5.5 3.21V20.8c0 .45.54.67.85.35l4.86-4.86H19.5c.32 0 .5-.4.27-.63L5.5 3.21z" fill="currentColor" />
                            </svg>
                            <span className="bg-navy-600 text-white text-[8px] font-bold px-2 py-0.5 rounded-full tracking-wide whitespace-nowrap transition-colors duration-300">
                                AI Agent
                            </span>
                        </motion.div>
                    </div>
                    ...
                    {/* ─── Slider divider ──────────────────────────────────── */}
                    <div
                        className="absolute top-0 bottom-0 w-[2px] bg-navy-400/40 z-30 pointer-events-none"
                        style={{ left: `${sliderPosition}%`, transform: 'translateX(-50%)' }}
                    />
                    {/* Handle */}
                    <div
                        className="absolute top-1/2 z-30 -translate-y-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-white border border-navy-300/60 shadow-lg flex items-center justify-center pointer-events-none transition-colors duration-300"
                        style={{ left: `${sliderPosition}%` }}
                    >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" className="text-navy-500 transition-colors duration-300">
                    ...
                    >
                        {isDragging && dragDirection === 'right' ? (
                            ...
                            <div className="text-center bg-white/80 backdrop-blur-md px-6 py-4 rounded-2xl border border-navy-200/60 shadow-2xl">
                                <div className="text-[14px] font-mono uppercase tracking-[0.15em] text-navy-700 font-bold whitespace-nowrap">
                                    From Chaos
                                </div>
                                <div className="text-[11px] font-mono uppercase tracking-[0.2em] text-navy-500 mt-1 whitespace-nowrap">
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[11px] font-mono uppercase tracking-wider text-navy-600 font-semibold">The Old Way</span>
                            <span className="text-[10px] text-navy-500/60">— Fragmented tools</span>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <span className="text-[10px] text-navy-500/60">Unified workspace —</span>
                            <span className="text-[11px] font-mono uppercase tracking-wider text-navy-600 font-semibold">The JYT Way</span>
