  ...
  return (
    <div className="md:grid md:grid-cols-2 md:divide-x md:divide-gray-200">
      <div className="md:pr-14">
        ...
        <div className="mt-10 grid grid-cols-7 text-center text-xs font-semibold text-gray-500">
          <div>M</div>
          <div>T</div>
          <div>W</div>
          <div>T</div>
            ...
            <div key={day.date} className={classNames(dayIdx > 6 && 'border-t border-gray-200', 'py-2')}>
              <button
                ...
                className={classNames(
                  ...
                  'mx-auto flex w-8 h-8 items-center justify-center rounded-full'
                )}
              >
      ...
      <section className="mt-12 md:mt-0 md:pl-14">
        ...
        <ol className="mt-4 flex flex-col gap-y-1 text-sm text-gray-500">
          {meetings.map((meeting) => (
            <li
              key={meeting.id}
              className="group flex items-center gap-x-4 rounded-xl px-4 py-2 focus-within:bg-gray-100 hover:bg-gray-100"
            >
              <img src={meeting.imageUrl} alt="" className="w-10 h-10 flex-none rounded-full" />
              ...
              <Menu as="div" className="relative opacity-0 group-hover:opacity-100 focus-within:opacity-100">
                ...
                <MenuItems
                  transition
                  className="absolute right-0 z-10 mt-2 w-36 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none data-closed:scale-95 data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
                >
                  <div className="py-1">
                    <MenuItem>
                      <a href="#" className="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:text-gray-900">
                        Edit
                      </a>
                    </MenuItem>
                    <MenuItem>
